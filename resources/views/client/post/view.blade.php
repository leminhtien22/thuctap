...
<div class="bg-[#1c1c1c] text-white py-16 px-4 min-h-screen font-poppins">
    <div class="max-w-7xl mx-auto">
        ...
        <h1 class="text-5xl font-bellefair text-[#f7c873] mb-12 text-center">Khám phá bài viết</h1>
                ...
                <div class="bg-[#2f2f2f] rounded-2xl overflow-hidden shadow-md hover:shadow-yellow-400/30 transition duration-300">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <div class="text-sm text-gray-400 mt-2">
                            <p><span class="text-white font-medium">Tác giả:</span> {{ $item->user->name }}</p>
                            <p><span class="text-white font-medium">Ngày tạo:</span> {{ $item->formatted_created_at }}</p>
                        </div>

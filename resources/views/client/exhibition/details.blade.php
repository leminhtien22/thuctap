...
@section('content')
    <div class="bg-[#1c1c1c] text-white py-12 px-4 min-h-screen font-sans">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-6">
                <div>
                    <h2 class="text-lg font-semibold text-yellow-300">Mô tả</h2>
                    <p class="text-gray-300 leading-relaxed">{{ $data->description }}</p>
                </div>

                <div>
                    <h2 class="text-lg font-semibold text-yellow-300">Bắt đầu</h2>
                    <p class="text-gray-300">{{ $data->formatted_start_date }}</p>
                </div>

                <div>
                    <h2 class="text-lg font-semibold text-yellow-300">Kết thúc</h2>
                    <p class="text-gray-300">{{ $data->formatted_end_date }}</p>
                </div>

                <div>
                    <h2 class="text-lg font-semibold text-yellow-300">Số lượng vé có sẵn</h2>
                    <p>
                ...
                @if ($data->is_expired)
                    <p class="text-red-500 text-sm font-semibold">{{ __('Hết hạn') }}</p>
                @else
                    <div class="pt-6">

                ...
                <div class="relative bg-[#2f2f2f] rounded-2xl overflow-hidden shadow-md hover:shadow-yellow-400/40 transition duration-300">
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div class="text-sm text-gray-400">
                            <p><span class="text-white font-medium">Loại:</span> {{ $item->formatted_type }}</p>
                            @if ($item->is_sale)
                                <p class="text-green-400 mt-1 font-semibold">Đang giảm giá!</p>
                            @endif
                        </div>
            ...
            @empty
                <div class="col-span-3">
                    <x-ui.alert type="warning">
                        {{ $searching ? 'Không tìm thấy bộ sưu tập với từ khoá "' . $searching . '"' : 'Chưa có bộ sưu tập nào được lên lịch' }}
                    </x-ui.alert>
                </div>
            @endforelse
        </div>

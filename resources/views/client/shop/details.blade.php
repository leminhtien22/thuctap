...
@section('content')
    <div class="px-4 py-6 bg-[#1c1c1c] text-white min-h-screen">
        <x-ui.breadcrumb :is-admin="0" is-dark :breadcrumbs="[ 
            ['url' => 'client.shop', 'label' => 'Shop'],
            ['url' => 'client.shop.details', 'param' => $data->id, 'label' => 'Shop Item Details'],
        ]" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <h2 class="text-lg font-semibold">Shop Item Type:</h2>
